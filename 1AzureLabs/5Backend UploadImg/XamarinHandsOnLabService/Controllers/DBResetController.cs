    ...
    public class DBResetController : ApiController
    {
        ...
        public void UserInit()
        {
            ...
            var fooAdmin = new DataObjects.Users
            {
                ...
                Department = "總經理室",
                Name = "管理者",
                PhotoUrl = "http://XamarinLOBTask.azurewebsites.net/Images/Admin.png",
            };
            ...
            for (int i = 0; i < 40; i++)
            {
                var fooUser = new DataObjects.Users
                {
                    ...
                    Department = $"Dept{i}",
                    Name = $"Name{i}",
                    PhotoUrl = "http://XamarinLOBTask.azurewebsites.net/Images/Man.png",
                    ManagerId = fooAdmin.Id,
                };

                if (i % 2 == 0)
                {
                    fooUser.PhotoUrl = "http://XamarinLOBTask.azurewebsites.net/Images/Woman.png";
                }
