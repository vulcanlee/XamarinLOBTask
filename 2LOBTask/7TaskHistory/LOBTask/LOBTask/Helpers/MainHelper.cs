...
namespace LOBTask.Helpers
{
    ...
    public class MainHelper
    {
        ...
        public static UserTaskRepository UserTasksService = new UserTaskRepository();
        public static UserHistoryTaskRepository UserHistoryTaskService = new UserHistoryTaskRepository();
        #endregion
    }
}
