...
namespace LOBTask.Repositories
{
    /// <summary>
    /// 提供存取後端使用者工作歷史紀錄服務
    /// </summary>
    public class UserHistoryTaskRepository
    {
        /// <summary>
        /// 呼叫 API 回傳後，回報的結果內容
        /// </summary>
            ...
            using (HttpClientHandler handler = new HttpClientHandler())
            {
                using (HttpClient client = new HttpClient(handler))
                {
                    try
                    {
                        ...
                        string FooUrl = $"{MainHelper.UserTasksHistoryAPIUrl}";
        ...
        public async Task Write()
        {
            ...
            await StorageUtility.WriteToDataFileAsync("", MainHelper.資料主目錄, MainHelper.UserTasksHistoryAPIName, data);
        }
        ...
        {
            string data = "";
            data = await StorageUtility.ReadFromDataFileAsync("", MainHelper.資料主目錄, MainHelper.UserTasksHistoryAPIName);
