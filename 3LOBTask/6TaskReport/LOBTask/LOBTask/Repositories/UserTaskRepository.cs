...
namespace LOBTask.Repositories
{
    ...
    public class UserTaskRepository
    {
            ...
            using (HttpClientHandler handler = new HttpClientHandler())
            {
                using (HttpClient client = new HttpClient(handler))
                {
                    try
                    {
                        ...
                        string FooUrl = $"{MainHelper.UserTasksAPIUrl}";
            ...
            using (HttpClientHandler handler = new HttpClientHandler())
            {
                using (HttpClient client = new HttpClient(handler))
                {
                    try
                    {
                        ...
                        string FooUrl = $"{MainHelper.UploadImageAPIUrl}";
                        HttpResponseMessage response = null;
        ...
        public async Task Write()
        {
            ...
            await StorageUtility.WriteToDataFileAsync("", MainHelper.資料主目錄, MainHelper.UserTasksAPIName, data);
        }
        ...
        {
            string data = "";
            data = await StorageUtility.ReadFromDataFileAsync("", MainHelper.資料主目錄, MainHelper.UserTasksAPIName);
